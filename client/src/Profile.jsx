...
const Profile=({setActiveRoute,profile,setSocket,setDescriptionRoom,setRoomName})=>{
    ...
    const [author]=useState(profile.person)
    ...
    const [data]=useState(formatarDataHoje())
    const [loading,setLoading]=useState(false);// pendente: implementar lógica para carregamento de dados
